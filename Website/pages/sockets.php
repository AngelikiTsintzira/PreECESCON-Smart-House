    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sockets Management</h1>
                ...
                <div class="col-lg-12">
                                    ...
                                    <tbody>
											<?php 
												 ...
												 {												 										 
													 ...
													 foreach($result as $row) 
													 {
														 $sql=$db->prepare("SELECT timestamp FROM savings WHERE id_sensor= :id_sensor");
														 $sql->bindParam(':id_sensor',$row['id_sensor'] );
														 $sql->execute();
														 $timestamp=$sql->fetchColumn();														 
														 ...
														 if ($row['default_value'] == 0)
														 {
															 echo " <tr><td>".$row['id_sensor']."</td>
																	...
																	<td>".$timestamp."</td>
																	<td><a href='../actions/update_sockets.php?id=".$row['id_sensor']."'> <button class='btn btn-primary'>Submit</button></a></td>
																	</tr>";
														 }
                 ...
                 <img src="../images/socket.png"  style="width:300px;height:300px;" align="right">
                <!-- /.col-lg-6 -->                       
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
