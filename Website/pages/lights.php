    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Lights Management</h1>
													 ...
													 foreach($result as $row) 
													 {
														 if ($row['default_value'] == 0)
														 {
															 echo " <tr><td>".$row['id_sensor']."</td>
																	...
																	<td><a href='../actions/update_lights.php?id=".$row['id_sensor']."'> <button class='btn btn-primary'>Submit</button></a></td>
																	</tr>";
														 }
														 else
														 {
                ...
                <img src="../images/light.jpg"  style="width:300px;height:300px;" align="right">
                <!-- /.col-lg-6 -->                       
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
