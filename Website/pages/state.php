    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Devices in <?php echo $location?></h1>
                   <div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
											<?php 
												 ...
												 for ($x = 0; $x <=$i ; $x++) 
												 {												 										 
													 $sql=$db->prepare("SELECT * FROM sensors WHERE id_arduino= :id_arduino and location=:location");
													 ...
													 foreach($result as $row) 
													 {
														 if ($row['default_value'] == 0)
														 {
															 echo " <tr><td>".$row['id_sensor']."</td>
																	...
																	<input type='checkbox' id='check' onchange='changeDisable()' name='check' disabled>
														 ...
														 else
														 {
															 echo " <tr><td>".$row['id_sensor']."</td>
																	<td>".$row['location']."</td>
																	<td><label class='switch'>
																	<input type='checkbox' id='check' onchange='changeDisable()' name='check' checked disabled>
																	<div class='slider round'></div>
																	</label> </td> </tr>";
														 }
